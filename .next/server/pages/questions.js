...
const getServerSideProps = async context => {
  ...
  await queryClient.prefetchQuery([_src_queries_usePostsQuery__WEBPACK_IMPORTED_MODULE_3__/* .QUERY_KEY */ .l, query, page], () => (0,_src_api_post__WEBPACK_IMPORTED_MODULE_4__/* .getPosts */ .Jq)({
    query,
    page
  }));
  return {
...
var __webpack_exports__ = __webpack_require__.X(0, [676,61,786,991,186], () => (__webpack_exec__(9721)));
